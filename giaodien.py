...
"")
        ...
        self.label_12.setGeometry(QtCore.QRect(20, 40, 55, 16))
        self.label_12.setObjectName("label_12")
        self.label_13 = QtWidgets.QLabel(self.tab)
        self.label_13.setGeometry(QtCore.QRect(20, 70, 55, 21))
        self.label_13.setObjectName("label_13")
        self.cluster_kmean_spin = QtWidgets.QSpinBox(self.tab)
        self.cluster_kmean_spin.setGeometry(QtCore.QRect(80, 40, 42, 22))
        self.cluster_kmean_spin.setMinimum(1)
        self.cluster_kmean_spin.setMaximum(20)
        self.cluster_kmean_spin.setProperty("value", 1)
        self.cluster_kmean_spin.setObjectName("cluster_kmean_spin")
        self.label_14 = QtWidgets.QLabel(self.tab)
        self.label_14.setGeometry(QtCore.QRect(80, 10, 191, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.iteration_kmean_spin = QtWidgets.QSpinBox(self.tab)
        self.iteration_kmean_spin.setGeometry(QtCore.QRect(80, 70, 42, 22))
        self.iteration_kmean_spin.setMinimum(1)
        self.iteration_kmean_spin.setMaximum(20)
        self.iteration_kmean_spin.setObjectName("iteration_kmean_spin")
        self.kmean_button = QtWidgets.QPushButton(self.tab)
        self.kmean_button.setGeometry(QtCore.QRect(140, 37, 141, 51))
        self.kmean_button.setObjectName("kmean_button")
        ...
        self.equalize_his_button = QtWidgets.QPushButton(self.centralwidget)
        self.equalize_his_button.setGeometry(QtCore.QRect(1150, 220, 101, 28))
        self.equalize_his_button.setStyleSheet("background-color:white")
        self.equalize_his_button.setObjectName("equalize_his_button")
        self.clear_his_button = QtWidgets.QPushButton(self.centralwidget)
        self.clear_his_button.setGeometry(QtCore.QRect(1300, 220, 101, 28))
        self.clear_his_button.setStyleSheet("background-color:white")
        self.clear_his_button.setObjectName("clear_his_button")
        self.label_7.raise_()
        self.label_3.raise_()
        self.label.raise_()
        ...
        self.label_9.raise_()
        self.equalize_his_button.raise_()
        self.clear_his_button.raise_()
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/open (2).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen.setIcon(icon1)
        self.actionOpen.setObjectName("actionOpen")
        self.actionOpen_2 = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../.designer/Huyhoang/open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_2.setIcon(icon2)
        self.actionOpen_2.setObjectName("actionOpen_2")
        self.actionSave = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("images/save2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon3)
        self.actionSave.setObjectName("actionSave")
        self.actionPrint = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/printer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("images/icons8-3d-rotate-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRotation.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("images/zoom_out_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionZoom_in.setIcon(icon7)
        self.actionZoom_in.setObjectName("actionZoom_in")
        self.actionZoom_out = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("images/zoom_in_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("images/histogram.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHistogram_equal.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("images/crop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCrop.setIcon(icon10)
        ...
        self.toolBar.addAction(self.actionHistogram_equal)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(_translate("MainWindow", "Cluster"))
        self.label_13.setText(_translate("MainWindow", "Iteration"))
        self.label_14.setText(_translate("MainWindow", "K Mean Clustering"))
        self.kmean_button.setText(_translate("MainWindow", "K Mean Clustering"))
        ...
        self.equalize_his_button.setText(_translate("MainWindow", "Equalize"))
        self.clear_his_button.setText(_translate("MainWindow", "Clear"))
